    ...
    $.widget("ui.tagit", {
                ...
                var soptions = {
                    ...
                    update:function (event, ui) {
                        ...
                        if(self.options.tagsChanged){
                            ...
                            self.options.tagsChanged.call(self, tag.value, 'moved', tag.element);
                        }
                    }
                };
                ...
                if (newValue == initialValue) {
                    ...
                    if (lastTagIndex != initialTagIndex) {
                        ...
                        if(this.options.tagsChanged) { //fire an update
                            ...
                            this.options.tagsChanged.call(this, tag.value, 'moved', tag.element);
                        }
                    }
                    finishEditing();
                }
        ...
        _popTag:function (tag) {
            ...
            if (this.options.tagsChanged)
                this.options.tagsChanged.call(this, tag? (tag.value || tag.label) : null, 'popped', tag);
            return;
        },
        ...
        _addTag:function (label, value) {
            ...
            if (this.options.select)
                this._addSelect(tag);
            if (this.options.tagsChanged)
                this.options.tagsChanged.call(this, tag.label, 'added', tag.element);
            return true;
        },
        ...
        reset:function () {
            ...
            this._initialTags();
            if (this.options.tagsChanged)
                this.options.tagsChanged.call(this, null, 'reset', null);
        },
